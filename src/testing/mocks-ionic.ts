...
export const FFSAuthServiceSpy = () => jasmine.createSpyObj('FFSAuthService', ['requireAuthenticated', 'requireAuthenticationWithRedirect', 'isAuthenticated', 'handleAuthCallbackWeb']);

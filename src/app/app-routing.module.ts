...
const routes: Routes = [
  ...
  { path: 'link/dictation-view', loadChildren: './pages/dictation-view/dictation-view.module#DictationViewPageModule' },
  { path: 'dictation-view/:dictationId', loadChildren: './pages/dictation-view/dictation-view.module#DictationViewPageModule' },
  { path: 'link/dictation-view/:dictationId', loadChildren: './pages/dictation-view/dictation-view.module#DictationViewPageModule' },
